...
echo [1/15] Removing default apps (v2)...
echo [1/15] Removing default apps (v2)... >> "%LOGFILE%"
...
echo [2/15] Disabling advertising ID... >> "%LOGFILE%"
...
echo [3/15] Disabling app suggestions...
echo [3/15] Disabling app suggestions... >> "%LOGFILE%"
...
echo [4/15] Disabling autologin...
echo [4/15] Disabling autologin... >> "%LOGFILE%"
...
echo [5/15] Disabling consumer features...
echo [5/15] Disabling consumer features... >> "%LOGFILE%"
...
echo [6/15] Disabling Cortana... >> "%LOGFILE%"
...
echo [7/15] Disabling error reporting...
echo [7/15] Disabling error reporting... >> "%LOGFILE%"
...
echo [8/15] Disabling feedback...
echo [8/15] Disabling feedback... >> "%LOGFILE%"
...
echo [9/15] Disabling maps updates...
echo [9/15] Disabling maps updates... >> "%LOGFILE%"
...
echo [10/15] Disabling quick access...
echo [10/15] Disabling quick access... >> "%LOGFILE%"
...
echo [11/15] Disabling telemetry...
echo [11/15] Disabling telemetry... >> "%LOGFILE%"
...
echo [12/15] Disabling web search in start menu...
echo [12/15] Disabling web search in start menu... >> "%LOGFILE%"
...
echo [13/15] Disabling Xbox features...
echo [13/15] Disabling Xbox features... >> "%LOGFILE%"
...
echo [14/15] Removing shortcuts from public desktop...
echo [14/15] Removing shortcuts from public desktop... >> "%LOGFILE%"
...
echo [15/15] Running cleanup and compact...
echo [15/15] Running cleanup and compact... >> "%LOGFILE%"
